...
We therefore use agglomerative hierarchical clustering, which controls the spatial etent of a cluster directly rather than via a density chain \cite{hastie2009elements}
